...
{
    public class AnilistCommand : IDiscordBotCommand
    {
        ...
        public string CommandName => "anilist";
        public string Help =>
@"#anlist <option>
...
Arguments:
    ...
    -studio <term>       Search for studio.";
        ...
        public AnilistCommand(AnilistClient client)
        {
            _client = client;
        }
        ...
        private void SendStudio(Studio studio, Channel channel)
        {
            channel.SendMessage(
                Format(_studioMsg,
                    studio.StudioName,
        ...
        private void SendStaff(StaffBig staff, Channel channel)
        {
            channel.SendMessage(
                Format(_staffMsg,
        ...
        private void SendCharacter(CharacterBig character, Channel channel)
        {
            channel.SendMessage(
                Format(_charMsg,
        ...
        private void SendAnime(AnimeBig anime, Channel channel)
        {
            channel.SendMessage(
                Format(_animeMsg,
                    anime.TitleRomaji, 
        ...
        private void SendManga(MangaBig manga, Channel channel)
        {
            channel.SendMessage(
                Format(_mangaMsg,
                    manga.TitleRomaji, 
